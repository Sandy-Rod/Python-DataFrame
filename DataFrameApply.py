...
#DF_empresa=pd.DataFrame({'ventas':s_ventas,"num_comerciales":s_comerciales,"mercado_potencial":sv_potenciales,"R-ventas":R_com_ventas,"R-merc_pot":R_ventas_MP})
...
print(DF_empresa)
print("Añadimos columna con aumento empleados")
...
# datos=[[1,2],[3,4],[5,6]]
# df_1=pd.DataFrame(datos,columns=["A","B"])
# #df_2=pd.DataFrame()
# print(df_1)
